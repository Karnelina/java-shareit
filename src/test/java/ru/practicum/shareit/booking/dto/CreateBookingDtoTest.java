...
class CreateBookingDtoTest {
    ...
    void testBookingSavingDto() throws IOException {
        ...
        CreateBookingDto bookingSavingDto = CreateBookingDto.builder()
                .itemId(null)
                .start(start)
                .end(end)
                .build();
        JsonContent<CreateBookingDto> jsonContent = bookingSavingDtoJacksonTester.write(bookingSavingDto);
