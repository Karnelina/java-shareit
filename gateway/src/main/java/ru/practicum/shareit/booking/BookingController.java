...
public class BookingController {
    ...
    @PostMapping
    public Object saveBooking(@Valid @RequestBody CreateBookingDto bookingSavingDto,
                              @RequestHeader(REQUEST_HEADER_USER_ID) long userId) {
        return bookingClient.saveBooking(bookingSavingDto, userId);
    }

    @GetMapping
    public Object findAllBookingsByUserId(@RequestHeader(REQUEST_HEADER_USER_ID) long userId,
    ...
    @GetMapping("/owner")
    public Object findOwnerBookings(@RequestHeader(REQUEST_HEADER_USER_ID) long userId,
                                    @ValuesAllowedConstraint(propName = "state",
                                            values = {"all",
                                                    "current",
                                                    "past",
